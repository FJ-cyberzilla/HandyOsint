...
\  \/  / / _` || '_ \/ _` || | | | | | || | / _  __|
 >  <  < | (_| || | | | (_| || |_| | |_|| || (_| |
/_/\_\ \_|\__,_||_| |_|\__,_| \__,_|\___/ |_| \__,_|
    """
...
class GradientTextRenderer:
    ...
    def __init__(self, scheme: ColorSchemePreset = ColorSchemePreset.HEAT_WAVE):
        self.scheme = scheme.value
        self.reset = "\033[0m"
    
    def apply_gradient(self, text: str, scheme: Optional[ColorSchemePreset] = None) -> str:
        """Apply gradient colors to text"""
        colors = (scheme or self.scheme).value if isinstance(scheme, ColorSchemePreset) else scheme or self.scheme
    ...
    def apply_rainbow(self, text: str, cycle: bool = False) -> str:
        ...
        rainbow = [196, 208, 226, 82, 51, 33, 127]  # Red, Orange, Yellow, Lime, Cyan, Blue, Magenta
...
class SleekChart:
    ...
    def render_bar_chart(
        ...
        for label, value in data.items():
            ...
            result += f"{label:<{max_label_len}} |\033[38;5;{color}m{bar}\033[0m| {value_str}\n"
...
"""
    ...
    def change_scheme(self, scheme: ColorSchemePreset) -> None:
        """Change color scheme"""
        self.scheme = scheme
        self.gradient = GradientTextRenderer(scheme)
        self.chart = SleekChart(scheme)
    ...
    def get_system_status_dashboard(
        ...
        dashboard += self.chart.render_bar_chart(status_data, width=30, show_values=True)
    ...
    def create_custom_banner(
        ...
        title: str,
        subtitle: str = "",
        scheme: Optional[ColorSchemePreset] = None
    ) -> str:
...
def demo_charts() -> None:
    ...
    print(banner.chart.render_line_chart(line_data, height=8, width=40, title="Detection Rate"))
...
if __name__ == "__main__":
    ...
    banner_gen = AdvancedBannerGenerator(ColorSchemePreset.HEAT_WAVE)
    
    # Display main banner
    print("\n" + banner_gen.get_main_banner())
    
    # Display status dashboard
    print(banner_gen.get_system_status_dashboard(cpu=67, memory=54, network=82, scans=78))
    
    # Display threat level
    print(banner_gen.get_threat_level_display(level=4))
    
    # Display custom banner
    print(banner_gen.create_custom_banner(
