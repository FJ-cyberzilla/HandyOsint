...
from core.production_scanner import ProductionScanner, UsernameSearchResult, ScanResultDetail
...
async def startup_event():
    ...
    scanner = ProductionScanner(max_concurrent=10) # Max concurrent requests can be loaded from config
